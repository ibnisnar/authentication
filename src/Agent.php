...
class Agent extends MobileDetect
{
    ...
    {
        return $this->retrieveUsingCacheOrResolve('authentication.platform', function () {
    ...
    {
        return $this->retrieveUsingCacheOrResolve('authentication.browser', function () {
            return $this->findDetectionRulesAgainstUserAgent(
    ...
    {
        return $this->retrieveUsingCacheOrResolve('authentication.desktop', function () {
